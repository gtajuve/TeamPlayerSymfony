 ...
 */
class Version20170712224620 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE roster DROP player_id, DROP game_id');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE roster ADD player_id INT DEFAULT NULL, ADD game_id INT DEFAULT NULL');
